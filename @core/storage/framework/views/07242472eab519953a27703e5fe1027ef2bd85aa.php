                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.profile.update')); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <small class="info-text"><?php echo e(__('Recommended Image Size 100x100. Accepted format: jpg,png.jpeg. Size less than 2MB')); ?></small>
                            </div>
                            <div class="form-group">
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\cyber\Altdream.app\@core\resources\views/auth/admin/edit-profile.blade.php ENDPATH**/ ?>
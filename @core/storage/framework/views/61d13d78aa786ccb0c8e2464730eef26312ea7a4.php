...
<section class="login-page-wrapper">
    <div class="container">
        ...
        <div class="row justify-content-center py-5 my-5" style="padding-top:50px;padding-bottom:50px">
            <div class="col-lg-6">
                <div class="login-form-wrapper">
                    <h2><?php echo e($title ?? __('Signin')); ?></h2><br>
                        ...
                        <div class="row mb-4 rmber-area">
                            <div class="col-6">
                                <div class="custom-control custom-checkbox mr-sm-2">
                                    ...
                                    <label class="custom-control-label" for="remember"><?php echo e(__('Stay signed in')); ?></label>
                                </div>
                            </div>
                            <div class="col-6 text-right">
                                <a class="d-block" href="<?php echo e(route('user.register')); ?>"><?php echo e(__('Signup for new account?')); ?></a>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\cyber\Altdream.app\@core\resources\views/frontend/user/login.blade.php ENDPATH**/ ?>
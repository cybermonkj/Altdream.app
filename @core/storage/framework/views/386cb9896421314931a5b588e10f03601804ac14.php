<?php $__env->startSection('site-title'); ?>
    <?php echo e(__('Apply Job Form Builder')); ?>
            ...
            <div class="col-lg-6 mt-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.form.builder.apply.job.form')); ?>" method="Post">
                            <div class="alert alert-warning">
                                <?php echo e(__('name, email filed will be added automatically')); ?>

                            </div>
                            <?php echo csrf_field(); ?>
                            <?php echo render_drag_drop_form_builder_markup(get_static_option('apply_job_page_form_fields')); ?>

                            <button id="update" type="submit" class="btn btn-primary mt-4 pr-4 pl-4 margin-bottom-40"><?php echo e(__('Save Change')); ?></button>
                        </form>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cybermonkj/Altdream.app/@core/resources/views/backend/form-builder/apply-job-form.blade.php ENDPATH**/ ?>
            ...
            <div class="col-12 mt-5">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.event.payment.report')); ?>" method="get" enctype="multipart/form-data" id="report_generate_form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2">
                                    <button id="search" type="submit" class="btn btn-primary mt-4 pr-4 pl-4"><?php echo e(__('Submit')); ?></button>
...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.btn.search','data' => []]); ?>
<?php $component->withName('btn.search'); ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\cyber\Altdream.app\@core\resources\views/backend/events/payment-report.blade.php ENDPATH**/ ?>
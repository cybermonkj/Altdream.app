            ...
            <div class="login-box ptb--100">
                <form method="POST" action="<?php echo e(route('admin.login')); ?>">
                    ...
                    <div class="login-form-head">
                        ...
                        <p><?php echo e(__('Hello there, Please provide your authentication details to Sign in ')); ?></p>
                    </div>
...
<?php echo $__env->make('layouts.login-screens', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\cyber\Altdream.app\@core\resources\views/auth/admin/login.blade.php ENDPATH**/ ?>
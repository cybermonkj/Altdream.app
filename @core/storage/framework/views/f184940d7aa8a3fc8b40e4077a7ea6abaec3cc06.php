                    ...
                    <tr>
                        ...
                        <td>
                            <?php if($data->payment_status == 'pending' && $data->status != 'cancel'): ?>
                                ...
                                <a href="<?php echo e(route('frontend.event.booking.confirm',$data->id)); ?>" class="btn-success btn-sm ml-2"><?php echo e(__('Pay Now')); ?></a>
...
<?php echo $__env->make('frontend.user.dashboard.user-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\cyber\Altdream.app\@core\resources\views/frontend/user/dashboard/event-booking.blade.php ENDPATH**/ ?>
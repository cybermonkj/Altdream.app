...
<?php $__env->startSection('site-title'); ?>
    <?php echo e(__('All Pending Donations')); ?>
    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="col-lg-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title"><?php echo e(__('All Pending Donations Cause')); ?></h4>
        ...
        $(function () {
            ...
            $(document).ready(function (){
                $('.table-wrap > table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "<?php echo e(route('admin.donations.pending.all')); ?>",
                    columns: [
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cybermonkj/Altdream.app/@core/resources/views/backend/donations/pending-donations.blade.php ENDPATH**/ ?>
    ...
    <div class="cart-table-wrapper cart-wrapper">
        ...
        <div class="package-info-wrap">
            @if(!empty($payment_details))
                <h2 class="main_title">{{__('Item Information')}}</h2>
                <ul>
                    <li><strong>{{__('Order ID')}}</strong> #{{$payment_details->order_id}}</li>
                    <li><strong>{{__('Order Date')}}</strong> {{date_format($payment_details->created_at,'d M Y')}}</li>
                    <li><strong>{{__('item Name')}}</strong> {{$payment_details->package_name}}</li>
                    <li><strong>{{__('Price')}}</strong> {{amount_with_currency_symbol($payment_details->package_price,true)}}</li>
                    <li><strong>{{__('Description')}}</strong> {{$payment_details->order_id}}</li>
                </ul>
            @endif
        </div>
    </div>

    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{__('File Uploads')}}</h5>
            ...
            <div class="modal-body">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="upload_files" role="tabpanel" >
                        @php $imageUploadRoute = $imageUploadRoute ?? route('admin.upload.media.file');  @endphp
                        <div class="dropzone-form-wrapper">
                            <form action="{{$imageUploadRoute}}" method="post" id="placeholderfForm" class="dropzone" enctype="multipart/form-data">
                                @csrf
                                @if(isset($userUpload) && $userUpload)
